...
GIT_LFS_SKIP_SMUDGE=1 git subtree pull --prefix=pyPhoCoreHelpers remote-pyPhoCoreHelpers release/pho-diba-2025-paper --squash
GIT_LFS_SKIP_SMUDGE=1 git subtree pull --prefix=pyPhoPlaceCellAnalysis remote-pyPhoPlaceCellAnalysis develop --squash

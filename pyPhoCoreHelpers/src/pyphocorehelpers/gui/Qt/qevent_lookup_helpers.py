...
class QEventLookupHelpers:
    """ from https://stackoverflow.com/questions/62196835/how-to-get-string-name-for-qevent-in-pyqt5 
 
        https://stackoverflow.com/a/63640326/9732163
        answered Aug 28, 2020 at 20:12
        **pyjamas**
    """
    ...
    @classmethod
    def get_event_string(cls, event) -> str:
        """ returns string representation of event 
        
        Usage:
            print(QEventLookupHelpers.event_lookup[str(event.type())])
        """
        if isinstance(event, QtCore.QEvent):
            event_identifier = str(event.type())
        elif isinstance(event, (QtCore.QEvent.Type, int, str)):
            event_identifier = str(event)
        else:
            raise NotImplementedError
        return cls.event_lookup[event_identifier]
